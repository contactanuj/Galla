    ...
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      ...
      <ScrollView className="flex-1" contentContainerClassName="p-4">
        <View className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-200 dark:border-slate-700">
          ...
          {balance > 0 && (
            <View className="flex-row justify-between mt-1 pt-2 border-t border-slate-100 dark:border-slate-800">
              <Text className="text-sm font-semibold text-amber-700 dark:text-amber-300">{t('invoice.balance')}</Text>
              <Text className="text-sm font-bold text-amber-700 dark:text-amber-300">{money(balance)}</Text>
            </View>
          )}
        ...
        <View className="flex-row gap-3 mt-3">
          <TouchableOpacity onPress={handleShare} className="flex-1 bg-slate-100 dark:bg-slate-800 rounded-xl py-3 items-center flex-row justify-center active:bg-slate-200 dark:active:bg-slate-700">
          ...
          <TouchableOpacity onPress={handlePrint} className="flex-1 bg-slate-100 dark:bg-slate-800 rounded-xl py-3 items-center flex-row justify-center active:bg-slate-200 dark:active:bg-slate-700">
